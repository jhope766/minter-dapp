const contractAddress = "0x4313A7d0EbFD80517f28Cd8DB75D79b8CA1E5e59"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the SportApes NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The SportApes NFT Project is a decentralized, open-source project.';
